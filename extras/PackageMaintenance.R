...
#
# This file is part of CovCoagBasePrediction
#
...
OhdsiRTools::checkUsagePackage("CovCoagBasePrediction")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/CovCoagBasePrediction.pdf")
shell("R CMD Rd2pdf ./ --output=extras/CovCoagBasePrediction.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "CovCoagBasePrediction")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("CovCoagBasePrediction")
