...
.createCohorts <- function(connection,
  ...
  # Instantiate cohorts:
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "CovCoagBasePrediction")
  ...
  if(!is.null(cohortVariableSetting)){
    ...
    pathToCustom <- system.file("settings", cohortVariableSetting, package = "CovCoagBasePrediction")
