...
#'
#' @details
#' This function executes the CovCoagBasePrediction Study.
#' 
  ...
  if(createValidationPackage){
    ...
    if(!saveModelsToJson){
      ...
      tryCatch({
        ...
        createValidationPackageJson(devPackageName = 'CovCoagBasePrediction',
                                    devDatabaseName = cdmDatabaseName,
                                    analysisLocation = outputFolder,
                                    analysisIds = analysesToValidate,
                                    outputFolder = outputFolder,
                                    packageName = 'CovCoagBasePredictionValidation',
                                    description = 'validating models in CovCoagBasePrediction',
                                    skeletonVersion = skeletonVersion,
                                    createdBy = 'anonymous',
